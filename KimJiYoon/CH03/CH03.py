...
# a가 4미만인 레코드들을 삭제하시오
print(df)
print(df[df['a'] < 4].index)
print(df.drop(df[df['a'] < 4].index))
# a가 3미만이고 c가 4인 레코드를 삭제하시오
print(df)
df[(df['a'] < 3) & (df['c'] == 4)].index
print(df.drop(df[(df['a'] < 3) & (df['c'] == 4)].index))
