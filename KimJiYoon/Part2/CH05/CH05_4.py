...
boostring_model = xgb.XGBClassifier(n_estimators=100)
boostring_model.fit(X_train, Y_train)
print(boostring_model.score(X_train, Y_train))
print(boostring_model.score(X_test, Y_test))
