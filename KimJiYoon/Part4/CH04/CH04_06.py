...
# 1.2 Data EDA
print('describe', pd.DataFrame(data, columns=iris['feature_names']).describe())
...
# min_sample_split
sample_50_tree = DecisionTreeClassifier(max_depth=50)
...
trees = [
    ...
    ('sample=50 truee', sample_50_tree)
]
...
# 평가하기
for idx, (tree, tree) in enumerate(trees):
