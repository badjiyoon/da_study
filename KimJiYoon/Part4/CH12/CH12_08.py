...
ratings = pd.read_csv("../../../comFiles/ratings_small.csv")
ratings = ratings[["userId", "movieId", "rating"]]

ratings.head()

# 다른 두 데이터를 이용해 `ratings` 데이터의 `movieId`에 맞는 영화 제목을 얻습니다.
movies = pd.read_csv("../../../comFiles/movies_metadata.csv")
links = pd.read_csv("../../../comFiles/links_small.csv")
...
top_k_weight_user_ids = top_k_weight.index
top_k_weight_user_ids
top_k_weight
...
prediction_rating
print(f"prediction_rating: {prediction_rating}")
