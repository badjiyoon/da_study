...
Original file is located at
    https://colab.research.google.com/drive/1h81lEfloUV1G5FyF7MTYBjOhgNRycP98

> https://www.kaggle.com/yuansaijie0604/xinjiang-pm
* PdM_errors.csv
* PdM_failures.csv
* PdM_machines.csv
* PdM_maint.csv
...
"""## 01. 데이터 소개 및 분석프로세스 수립
 : "강의자료 → Ch10. [실습8] 제조 공정 예측 유지 보수하기" 참고
...
telemetry = pd.read_csv("/content/drive/MyDrive/PdM_telemetry.csv", error_bad_lines=False)
errors = pd.read_csv("/content/drive/MyDrive/PdM_errors.csv", error_bad_lines=False)
maint = pd.read_csv("/content/drive/MyDrive/PdM_maint.csv", error_bad_lines=False)
failures = pd.read_csv("/content/drive/MyDrive/PdM_failures.csv", error_bad_lines=False)
machines = pd.read_csv("/content/drive/MyDrive/PdM_machines.csv", error_bad_lines=False)
