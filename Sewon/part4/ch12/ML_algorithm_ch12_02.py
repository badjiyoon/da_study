...
sklearn.metrics.pairwise의 euclidean_distances를 이용해 유클리디안 거리를 계산
"""
...
sklearn.metrics.pairwise의 cosine_similarity를 이용해 계산

유클리디안 유사도 계산과 마찬가지로 X와 Y를 각각 입력할 수 있고, X만 입력
"""
...
#3.2 피어슨 유사도 계산
"""피어슨 유사도는 numpy.corrcoef를 이용해 계산
